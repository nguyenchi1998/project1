...
class ScheduleController extends Controller
{
    ...
    public function status(Request $request, $id)
    {
        ...
        if (
            $schedule->status != config('schedule.status.new')
            && $status == config('schedule.status.new')
        ) {
    ...
    public function attendanceShow($id)
    {
        ...
        return view(
            'teacher.attendance',
            compact('scheduleDetails', 'schedule')
        );
    }
    ...
    public function attendance($id)
    {
        return $this->successRouteRedirect(
            'teacher.schedules.attendanceShow',
            $id,
            'Chưa làm logic đâu :D'
        );
    }
    ...
    public function markShow(Request $request, $id)
    {
        ...
        return view('teacher.mark', compact(
            'scheduleDetails',
            'schedule'
        ));
    }
