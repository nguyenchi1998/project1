...
<img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="#" class="brand-link">
            <img src="{{ asset('img/logo_small.jpeg') }}" alt="AdminLTE Logo" class="brand-image elevation-3"
                 style="opacity: .8">
        ...
        <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{ assetStorage(auth()->user()->avatar ?? '') }}" class="img-circle elevation-2"
                         alt="User Avatar">
                </div>
                <div class="info">
            ...
            <nav class="mt-3">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-header text text-uppercase">Student</li>
                    <li class="nav-item">
                    ...
                    <li class="nav-header text text-uppercase">Schedule</li>
                    <li class="nav-item">
