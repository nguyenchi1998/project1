    ...
    <div class="content-wrapper">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('specializations.index') }}">Manager Specializations</a>
                    </li>
        ...
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(['url' => route('specializations.update', $specialization->id) , 'method' => 'POST', 'class' => "forms-sample" ]) }}
                        @method('PUT')
