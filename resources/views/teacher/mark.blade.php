                                ...
                                @foreach ($scheduleDetails as $student)
                                    <tr>
                                        <td>
                                            ...
                                            {{ Form::text('student_id', $student->student->id, [
                                                'hidden' => true,
                                                'class' => 'form-control',
                                            ]) }}
                                        </td>
                                        <td style="width: 200px">
                                            {{ Form::number('activity_mark', $student->activity_mark, [
                                                'class' => 'form-control',
                                                'min' => 0,
                                                'max' => 10,
                                            ]) }}
                                        ...
                                        <td style="width: 200px">
                                            {{ Form::number('middle_mark', $student->middle_mark, [
                                                'class' => 'form-control',
                                                'min' => 0,
                                                'max' => 10,
                                            ]) }}
                                        ...
                                        <td style="width: 200px">
                                            {{ Form::number('final_mark', $student->final_mark, [
                                                'class' => 'form-control',
                                                'min' => 0,
                                                'max' => 10,
                                            ]) }}
