            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-4">
                        <div class="w-25">
                            <form action="">
                                {{ Form::select('status', $states, $status ?? null, ['class' => 'form-control', 'placeholder' => 'Tất Cả Trạng Thái', 'onchange' => 'this.form.submit()']) }}
                            </form>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                @foreach($schedules as $schedule)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('teacher.schedules.status', $schedule->id) }}"
                                                  method="POST">
                                                @csrf
