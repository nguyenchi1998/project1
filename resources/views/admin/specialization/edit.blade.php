        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    {{ Form::open([
                        'url' => route('admin.specializations.update', $specialization->id),
                        'method' => 'POST',
                    ]) }}
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::input('text', 'name', $specialization->name, [
                            'class' => 'form-control',
                            'id' => 'name',
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::input('number', 'min_credit', $specialization->min_credit, [
                            'class' => 'form-control',
                            'id' => 'min_creddit',
                            'placeholder' => 'Sô Tín Chỉ Tối Thiểu',
                            'min' => 0,
                        ]) }}
                    </div>
                    <div class="mt-3">
