                            ...
                            @foreach($subjects as $key => $subject)
                                <tr>
                                    ...
                                    <td style="width: 150px">
                                        {{ Form::select('semester', $subject->type  == config('subject.type.basic') ? $basicSemesters : $specializationSemesters, $subject['semester'], ['class'=> 'form-control form-control-sm semester', 'placeholder' => 'Tất Cả kỳ học', 'disabled' => $subject['can_not_edit']]) }}
                                    </td>
                                    <td style="width: 150px">
