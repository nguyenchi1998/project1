                    ...
                    <div class="form-inline">
                        <div class="form-check form-check-info">
                            <label class="form-check-label">
                                {{ Form::radio('gender', config('config.gender.male.value'),  $student->gender == config('config.gender.male.value'),  ['class'=>'form-check-input']) }}
                        ...
                        <div class="ml-3 form-check form-check-info">
                            <label class="form-check-label">
                                {{ Form::radio('gender', config('config.gender.female.value'), $student->gender == config('config.gender.female.value'),  ['class'=>'form-check-input']) }}
