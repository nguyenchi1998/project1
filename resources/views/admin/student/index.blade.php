        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex mb-3 justify-content-between">
                    ...
                    <a class="btn Tìm Kiếmd-flex align-items-center btn-outline-success" href="{{ route('admin.students.create') }}">Tạo Mới</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td width="100">
                                    <div class="d-flex justify-content-between">
                                        <div class="mr-2">
                                            <a href="{{ route('admin.students.edit', $student->id) }}" class="btn btn-outline-warning">Sửa</a>
                                        </div>
                                        <div>
