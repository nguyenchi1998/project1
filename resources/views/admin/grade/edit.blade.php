    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(['url' =>route('admin.grades.update') , 'method' => 'POST', 'class' => "forms-sample" ]) }}
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::input('number', 'number_semester', $grade->number_semester, ['class' => 'form-control', 'id' => 'name', 'placeholder' => 'Enter Semester Number', 'min' => 1]) }}
                        </div>
