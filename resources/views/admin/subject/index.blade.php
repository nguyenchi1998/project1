                    ...
                    <div class="">
                        <form action="{{ route('admin.subjects.index') }}" class="form-inline">
                            ...
                            <select name="type-filter" class="form-control mr-2">
                                ...
                                <option value="{{ config('constant.subject_type.natural') }}" @if($typeFilter===config('constant.subject_type.natural')) selected @endif>Môn Tự Nhiên
                                </option>
                                <option value="{{ config('constant.subject_type.social') }}" @if($typeFilter===config('constant.subject_type.social')) selected @endif>
                                    Môn Xã Hội
                                </option>
                            </select>
