                    ...
                    <div class="d-flex mb-3 justify-content-between">
                        <form action="{{ route('admin.classes.index') }}">
                            <div class="d-flex justify-content-between">
                                ...
                                {{ Form::select('specializaiton-filter', $specializations, $filterSpecialization, ['class' => 'form-control ', 'onchange' => 'this.form.submit()', 'placeholder' => 'Tất cả Khoa Viện']) }}
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="mr-2">
                                                <a href="{{ route('admin.classes.students', $class->id) }}"
                                                   ...
                                                   data-placement="top" title="Danh Sách Sinh Viên">
