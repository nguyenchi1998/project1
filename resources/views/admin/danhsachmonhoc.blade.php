                        ...
                        <div class="col-lg-2">
                            ...
                            <select class="form-control" {{-- onchange="submit()" --}} id="manganh" name="manganh">
                                ...
                                @foreach($arrChuyennganh as $objChuyennganh)
                                    <option @if(isset($manganh)&&$manganh == $objChuyennganh->machuyennganh) selected
                                            @endif value="{{$objChuyennganh->machuyennganh}}">{{$objChuyennganh->tenchuyennganh}}</option>
                                @endforeach
                            </select>
                            {{-- </form> --}}
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{route('xoamonhoc')}}" method="get">
                                            <input type="hidden" name="txtMaMonHoc" value="{{$objMonHoc->mamonhoc}}">
                                            <button type="submit"
                                                    onclick="return confirm('Bạn có chắc chắn xóa quản trị viên này ?')"
