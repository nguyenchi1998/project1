                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="100">
                                    <div class="d-flex justify-content-between">
                                        <div class="mr-3">
                                            <a href="{{ route('admin.schedules.credits.students.registerScheduleShow', $student->id) }}" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="Đăng Ký Tín Chỉ"><i class="mdi mdi-book-open-page-variant"></i></i></a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
