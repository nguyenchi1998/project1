                        ...
                        <table class="table table-bordered table-hover" id="subjects">
                            ...
                            @foreach($specializationSubjects as $subject)
                                <tr>
                                    <td>
                                        {{ $subject->name }}
                                        @if($subject->pivot->force )<span
                                                class="badge badge-danger">Bắt Buộc</span> @endif
                                    ...
                                    <td class="text-center">
                                        {{ Form::checkbox('checked', $subject->id, $subject['force'] || in_array($subject->id, $scheduleDetails), ['onclick' => $subject['force'] ? 'return false' : 'return true', 'class' => 'selectSubject'])  }}
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
