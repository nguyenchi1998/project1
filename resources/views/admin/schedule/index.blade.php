                        ...
                        <div class="w-25">
                            <form action="">
                                <div class="d-flex justify-content-between">
                                    {{ Form::select('status', $states, $status , ['class' => 'form-control ', 'placeholder' => 'Tất Cả Trạng Thái', 'onchange' => 'this.form.submit()']) }}
                                    {{ Form::select('class-type', [0 => 'Lớp Học', 1 => 'Tự Do'], $classType, ['class' => 'ml-2 form-control ', 'placeholder' => 'Tất Cả Thể Loại', 'onchange' => 'this.form.submit()']) }}
                                </div>
                            </form>
                        </div>
