                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.schedules.teacher', $schedule->id) }}"
                                              method="post">
                                            @csrf
                                            {{ Form::select('teacher_id', $schedule->subject->teachers->pluck('name', 'id')->toArray(), $schedule->teacher->id ?? null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Chọn Giảng Viên', 'onchange' => 'this,form.submit()'])}}
                                        </form>
                                    </td>
                                    <td>
